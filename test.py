import sys
sys.path.append('/home/adanilishin/topoligy/myTorch/build')
import ctypes
ctypes.CDLL('/home/adanilishin/topoligy/myTorch/build/libtorchcpp.cpython-312-x86_64-linux-gnu.so')
import libtorchcpp
